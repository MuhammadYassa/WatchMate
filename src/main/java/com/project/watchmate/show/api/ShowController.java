...
public class ShowController {
    ...
    @Operation(summary = "List show reviews", description = "Returns paginated reviews for a show identified by TMDB ID.")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Show reviews returned (paginated)", content = @Content(schema = @Schema(implementation = ReviewResponseDTO.class))),
