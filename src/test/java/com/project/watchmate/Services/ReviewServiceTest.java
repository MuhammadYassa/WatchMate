...
class ReviewServiceTest {
    ...
    void setUp() {
        ...
        media = Media.builder().id(MEDIA_ID).tmdbId(TMDB_ID).title("Movie").build();
    ...
    class CreateReviewTests {
        ...
        void createReview_WhenValid_SavesAndReturnsDto() {
            CreateReviewRequestDTO request = CreateReviewRequestDTO.builder().tmdbId(TMDB_ID).type("MOVIE").starRating(5).comment("Great").build();
        ...
        void createReview_WhenAlreadyReviewed_ThrowsDuplicateReviewException() {
            CreateReviewRequestDTO request = CreateReviewRequestDTO.builder().tmdbId(TMDB_ID).type("MOVIE").build();
            when(mediaResolutionService.resolveMediaByTmdbId(TMDB_ID, "MOVIE")).thenReturn(media);
